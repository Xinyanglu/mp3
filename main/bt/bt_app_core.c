/*
 * Bluetooth app work queue.
 *
 * Provides a small FreeRTOS task and queue used to serialize Bluetooth callback
 * work outside the ESP-IDF Bluetooth callback context.
 */
